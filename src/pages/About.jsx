...
const philosophyPoints = [
  { title: 'Execution Matters', desc: 'Ideas without execution are just dreams. Michael\'s 35+ year track record is built on showing up, delivering, and doing the work that others won\'t.' },
  { title: 'Relationships Build Business', desc: 'Every major opportunity in Michael\'s career came through relationships built on trust, consistency, and mutual respect.' },
  { title: 'Details Create Trust', desc: 'Clients remember how events feel. The smallest detail — the lighting, the timing, the service touch — is the difference between good and unforgettable.' },
  { title: 'Strong Teams Drive Success', desc: 'No venue or event succeeds alone. Michael invests in building and training teams that deliver excellence at every guest touchpoint.' },
  { title: 'Hospitality Is Strategy', desc: 'Guest experience is not just service — it\'s competitive strategy. How you make people feel determines whether they come back and bring others with them.' },
];
    ...
    <>
      ...
      <section className="page-hero">
        <div className="page-hero__bg img-wrap">
          <img src="https://placehold.co/1920x600/111111/333333" alt="About hero" />
          <span className="placeholder-label">16:9 wide (1920×600) — About Page Hero Background</span>
        </div>
        ...
        <div className="container page-hero__inner">
          ...
          <FadeIn delay={0.1}>
            <h1 className="page-hero__title">35+ Years of Building,<br />Operating & Leading.</h1>
          </FadeIn>
          <FadeIn delay={0.2}>
            <p className="page-hero__subtitle">
              From a 13-year-old entrepreneur to the Event Specialist of Manhattan —
              the story of a career built through relentless execution, deep relationships,
              and a passion for extraordinary hospitality.
            </p>
          </FadeIn>
        </div>
      </section>
          ...
          <div className="about-opening__grid">
            <FadeIn direction="right">
              <div className="about-opening__img img-wrap">
                <img src="https://placehold.co/580x720/e8e4dc/aaa" alt="Michael Tardi" />
                <span className="placeholder-label">4:5 (580×720) — Professional Headshot</span>
              </div>
            </FadeIn>
            ...
            <div className="about-opening__text">
              ...
              <FadeIn delay={0.4}>
                <p className="about-opening__body">
                  What began at age 13 as a music entertainment startup grew into MMEink —
                  a full-service event production company operating across Manhattan, Long Island,
                  and South Florida. Along the way, Michael developed an exclusive portfolio of
                  iconic venues, built beloved F&amp;B brands, and produced events for Fortune 500
                  companies, government dignitaries, and global entertainment properties.
                </p>
              </FadeIn>
              <FadeIn delay={0.45}>
                <p className="about-opening__body">
                  His work connects venue operations, event production, hospitality strategy,
                  real estate opportunities, and brand partnerships in a way that very few in the
                  industry can. Today, Michael applies those 35+ years of hard-earned insight to
                  consulting, speaking, investing, and building the next generation of hospitality
      ...
      <section className="section section--alt about-timeline">
        <div className="container">
          ...
          <FadeIn delay={0.1}>
            <h2 className="section-title">Building a Legacy, Milestone by Milestone</h2>
          </FadeIn>
          <FadeIn delay={0.2}>
            <div className="gold-divider" />
          </FadeIn>
              ...
              <FadeIn key={i} delay={i * 0.1}>
                <div className="timeline-item">
                  ...
                  <div className="timeline-item__connector">
                    ...
                    {i < timelineItems.length - 1 && <div className="timeline-item__line" />}
                  </div>
      ...
      <section className="section about-philosophy">
        <div className="container">
          ...
          <FadeIn delay={0.1}>
            <h2 className="section-title">The Principles That Drive Every Partnership</h2>
          </FadeIn>
          <FadeIn delay={0.2}>
            <div className="gold-divider" />
          </FadeIn>
      ...
      <section className="section section--dark about-cta">
        <div className="container about-cta__inner">
          <FadeIn>
            <span className="section-label">Ready to Connect?</span>
          </FadeIn>
          <FadeIn delay={0.1}>
