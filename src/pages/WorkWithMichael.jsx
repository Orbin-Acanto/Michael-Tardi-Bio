  ...
  return (
    <section ref={ref} className="wwm-cta">
      ...
      <div className="container wwm-cta__inner">
        <FadeIn>
          <span className="section-label" style={{ display: "block", textAlign: "center" }}>Next Steps</span>
        </FadeIn>
        <FadeIn delay={0.1}>
          <h2 className="wwm-cta__title">Ready to Move Forward?</h2>
        </FadeIn>
        <FadeIn delay={0.2}>
          <p className="wwm-cta__text">
            Whether you are looking to enhance your operations, develop your
            team, grow your business, or explore partnership opportunities,
            Michael brings a results-driven approach backed by decades of
            proven success.
          </p>
        </FadeIn>
        <FadeIn delay={0.3}>
        ...
        <div className="container page-hero__inner">
          ...
          <FadeIn delay={0.2}>
            <p className="page-hero__subtitle">
              Whether you need operational guidance, an inspiring voice in the
              room, or a strategic investment partner, Michael brings 35+ years
              of real-world results to every engagement.
            </p>
          </FadeIn>
        </div>
      </section>
            ...
            <div className="wwm-text">
              ...
              <FadeIn delay={0.25}>
                <p className="wwm-body">
                  Michael Tardi provides hands-on consulting and training for
                  venues, hospitality groups, event companies, and corporate
                  teams looking to improve operations, increase revenue, and
                  deliver stronger guest experiences.
                </p>
              </FadeIn>
              <FadeIn delay={0.3}>
        ...
        <div className="container">
          <div className="wwm-grid wwm-grid--reverse">
            ...
            <div className="wwm-text">
              ...
              <FadeIn delay={0.25}>
                <p className="wwm-body">
                  Michael is available for guest speaking engagements, panels,
                  corporate sessions, and mentorship programs focused on
                  hospitality, entrepreneurship, sales, leadership, and business
                  growth.
                </p>
              </FadeIn>
              <FadeIn delay={0.3}>
            ...
            <div className="wwm-text">
              <FadeIn>
                <span className="section-label">
                  03 Investment & Strategic Partnerships
                </span>
              </FadeIn>
              <FadeIn delay={0.1}>
                <h2 className="section-title">
              ...
              <FadeIn delay={0.25}>
                <p className="wwm-body">
                  Michael is open to select private investment and partnership
                  opportunities with brands, real estate owners, hospitality
                  groups, food and beverage companies, and event-driven
                  businesses. He partners with operators and founders to help
                  scale, structure, and grow businesses through both capital and
                  expertise.
                </p>
              </FadeIn>
              <FadeIn delay={0.3}>
